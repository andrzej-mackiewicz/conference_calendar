...
<html lang="pl">
  ...
  <script>
	...
	function printMonth(){
      ...
      <!--górne menu--><div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        	...
        	<a class="btn btn-dark nav-link" style="color:rgba(255, 255, 255, 0.5)" href="" onclick="printMonth()" aria-haspopup="true" aria-expanded="false">Drukuj wokande</a>
            ...
            <!--data--><ul class="navbar-nav ml-md-auto zegar">
				<div class="navbar-nav ml-md-auto text-white">
					...
					<div class="col-sm-7"> 
						<select id="fieldView" onchange="viewCalendar()" class="form-control form-control-sm" style="height:22px;padding:0px" disabled>
						  <option selected value="3">Sala nr. 3</option>
						</select>
					</div>
				  </div>
	...
	<div class="card" id="addFrame" style="display: none;width:650px;height:385px;max-height:499px;position: absolute;top: 10%; left: 50%; transform: translate(-50%, 0);">
	  ...
	  <div class="card-body p-2">
		<form>
		  <div class="form-group row mb-2">
			...
			<div class="col-sm-10">
			  <input type="name" id="fieldUser" onkeydown="charLimit(this, 30);" onkeyup="charLimit(this, 30);" class="form-control form-control-sm" placeholder="Wpisz tutaj swoje imię i nazwisko" required>
			</div>
		  </div>
		  <hr class="p-1 m-0">
		  <div class="form-group row mb-2">
			...
			<div class="col-sm-10">
			  <input type="name" id="fieldSignature" onkeydown="charLimit(this, 50);" onkeyup="charLimit(this, 50);" class="form-control form-control-sm" placeholder="Wpisz tutaj sygnaturę sprawy" required>
			</div>
		  </div>
		  <div class="form-group row mb-2">
			...
			<div class="col-sm-10"> 
				<select id="fieldJudge" class="form-control form-control-sm">
					...
					<option value="Arkadiusz Grzelczak">IXE: Arkadiusz Grzelczak</option>
					<option value="Marek Iwaszkiewicz">IXE: Marek Iwaszkiewicz</option>
					<option value="Anna Pasiewicz-Kuciak">IXE: Anna Pasiewicz-Kuciak</option>
		  ...
		  <div id="blockEmail" class="form-group row mb-2">
			...
			<div class="btn-group d-flex" role="group">
			  <input type="name" id="btnEmail" class="form-control form-control-sm" placeholder="Wpisz tutaj nazwę sądu, zakładu karnego itp. i kliknij +">
